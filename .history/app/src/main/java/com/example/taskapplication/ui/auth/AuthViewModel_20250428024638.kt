...
class AuthViewModel @Inject constructor(
    ...
    fun register(name: String, email: String, password: String) {
        viewModelScope.launch {
            ...
            // Test API directly first
            val apiTestResult = ApiTester.testRegister(name, email, password)
            Log.d(TAG, "API Test Result: $apiTestResult")
    ...
    fun loginWithGoogle(idToken: String? = null) {
        viewModelScope.launch {
            ...
            try {
                // Test API directly first
                val apiTestResult = ApiTester.testGoogleLogin(idToken)
                Log.d(TAG, "API Test Result for Google Login: $apiTestResult")
