...
class DataStoreManager @Inject constructor(
    ...
    suspend fun saveUserSettings(settings: com.example.taskapplication.data.api.response.UserSettings) {
        context.dataStore.edit { preferences ->
            ...
            preferences[PreferencesKeys.NOTIFICATIONS_ENABLED] = settings.notifications_enabled
            preferences[PreferencesKeys.TASK_REMINDERS] = settings.task_reminders
            preferences[PreferencesKeys.TEAM_INVITATIONS] = settings.team_invitations
            preferences[PreferencesKeys.TEAM_UPDATES] = settings.team_updates
            preferences[PreferencesKeys.CHAT_MESSAGES] = settings.chat_messages
        }
    }
