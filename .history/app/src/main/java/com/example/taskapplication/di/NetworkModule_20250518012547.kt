...
import com.example.taskapplication.data.api.PersonalTaskResponseAdapter
...
object NetworkModule {
    ...
    fun provideGson(): Gson {
        return GsonBuilder()
            .registerTypeAdapter(PersonalTaskResponse::class.java, PersonalTaskResponseAdapter())
    ...
    fun provideRetrofit(okHttpClient: OkHttpClient, gson: Gson): Retrofit {
        return Retrofit.Builder()
            .baseUrl("http://10.0.2.2:8000/api/v1/") // URL for accessing localhost from Android emulator
            .client(okHttpClient)
