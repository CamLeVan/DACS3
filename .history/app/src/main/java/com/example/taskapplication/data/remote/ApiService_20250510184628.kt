...
interface ApiService {
    ...
    ): Response<ApiResponse<DocumentFolderDto>>
    ...
    ): Response<ApiResponse<ApiMessageResponse>>
    ...
    suspend fun getDocumentVersions(
        @Path("documentId") documentId: String
    ): Response<ApiResponse<List<DocumentVersionDto>>>
    ...
    ): Response<ApiResponse<DocumentVersionDto>>
