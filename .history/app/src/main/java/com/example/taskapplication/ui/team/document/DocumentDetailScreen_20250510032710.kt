                ...
                Column(
                    ...
                    Row(
                        ...
                        Column {
                            ...
                            Text(
                                text = DateConverter.formatLong(document.uploadedAt),
                                style = MaterialTheme.typography.bodyMedium
                            )
                        }
                    }
                    ...
                    Row(
                        ...
                        Column {
                            ...
                            Text(
                                text = DateConverter.formatLong(document.lastModified),
                                style = MaterialTheme.typography.bodyMedium
                            )
                        }
    ...
    Card(
        ...
        Row(
            ...
            Column(
                ...
                Text(
                    text = "Granted at: ${DateConverter.formatLong(permission.grantedAt)}",
                    style = MaterialTheme.typography.bodySmall
                )
            }
