                ...
                if (networkUtils.isNetworkAvailable()) {
                    try {
                        ...
                        if (response.isSuccessful && response.body() != null) {
                            val remoteFolders = response.body()!!.data.map { it.toDomain() }

                            // Lưu vào cơ sở dữ liệu cục bộ
                            remoteFolders.forEach { folder ->
                                documentFolderDao.insertFolder(folder.toEntity(folder.id))
                            }
        ...
        return withContext(Dispatchers.IO) {
            try {
                ...
                if (localFolder != null) {
                    ...
                    if (response.isSuccessful && response.body() != null) {
                        val remoteFolder = response.body()!!.data.toDomain()

                        // Lưu vào cơ sở dữ liệu cục bộ
                        documentFolderDao.insertFolder(remoteFolder.toEntity(remoteFolder.id))
            ...
            try {
                if (networkUtils.isNetworkAvailable()) {
                    ...
                    if (response.isSuccessful && response.body() != null) {
                        ...
                        documentFolderDao.insertFolder(localFolder.toEntity(localId))
            ...
            try {
                if (networkUtils.isNetworkAvailable()) {
                    ...
                    if (response.isSuccessful && response.body() != null) {
                        ...
                        documentFolderDao.updateFolder(remoteFolder.toEntity(remoteFolder.id))
                        ...
                        documentFolderDao.updateFolder(localFolder.toEntity(folder.id))
            ...
            try {
                ...
                if (networkUtils.isNetworkAvailable()) {
                    try {
                        ...
                        if (response.isSuccessful && response.body() != null) {
                            val remoteDocuments = response.body()!!.data.map { it.toDomain() }
