...
interface DocumentDao {
    ...
    suspend fun getDocumentsByTeam(teamId: String): List<DocumentEntity>

    /**
     * Get documents in a folder
     */
    @Query("SELECT * FROM documents WHERE folderId = :folderId AND isDeleted = 0 ORDER BY name ASC")
    suspend fun getDocumentsByFolder(folderId: String): List<DocumentEntity>
    ...
    suspend fun getRootDocuments(teamId: String): List<DocumentEntity>
