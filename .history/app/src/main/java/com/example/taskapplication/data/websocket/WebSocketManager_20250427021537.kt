...
class WebSocketManager @Inject constructor(
    ...
    fun connect(serverUrl: String, authToken: String, teamId: Long) {
        ...
        try {
            ...
            when (eventName) {
                ...
                "user-typing" -> {
                    ...
                    _events.emit(ChatEvent.UserTyping(userId, isTyping))
                }
                "message-reaction-updated" -> {
                    ...
                    _events.emit(ChatEvent.MessageReaction(messageId, userId, reaction, action))
                }
                "message-updated" -> {
                    val message = parseMessage(data)
