...
object AnimationUtils {
    ...
    /**
     * Default animation duration for dialogs
     */
    const val DIALOG_ANIMATION_DURATION = 200

    /**
     * Default animation duration for list items
     */
    const val LIST_ITEM_ANIMATION_DURATION = 150

    /**
     * Default animation duration for tabs
     */
    const val TAB_ANIMATION_DURATION = 250

    /**
     * Default animation spec for spring animations
     */
    ...
    /**
     * Default animation spec for tween animations
     */
