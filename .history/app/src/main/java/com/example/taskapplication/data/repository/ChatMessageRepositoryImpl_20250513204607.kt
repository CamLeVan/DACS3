                    ...
                    if (attachments != null && attachments.isNotEmpty()) {
                        for (attachment in attachments) {
                            ...
                            if (file.exists()) {
                                ...
                                val requestFile = RequestBody.create(okhttp3.MediaType.Companion.get(attachment.fileType), file)
                                val filePart = MultipartBody.Part.createFormData("file", file.name, requestFile)
                                val typeBody = RequestBody.create(okhttp3.MediaType.Companion.get("text/plain"), "attachment")
