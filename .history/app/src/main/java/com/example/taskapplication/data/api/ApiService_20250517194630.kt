...
interface ApiService {
    ...
    // Personal Tasks
    @GET("personal-tasks")
    suspend fun getPersonalTasks(): Response<PersonalTaskListResponse>
    ...
    @GET("personal-tasks/filter")
    suspend fun filterPersonalTasks(
    ...
    @GET("personal-tasks/search")
    suspend fun searchPersonalTasks(
    ...
    // Subtasks
    @GET("personal-tasks/{taskId}/subtasks")
    suspend fun getSubtasks(@Path("taskId") taskId: String): Response<List<SubtaskResponse>>
    ...
    @PUT("personal-tasks/{taskId}/subtasks/{subtaskId}")
    ...
    @POST("personal-tasks/{taskId}/subtasks/order")
    suspend fun updateSubtaskOrder(
        @Path("taskId") taskId: String,
        @Body request: SubtaskOrderRequest
    ): Response<Unit>
