...
class PersonalTasksViewModel @Inject constructor(
     ...
     */
    fun showSyncDisabledMessage() {
        viewModelScope.launch {
            _syncState.value = SyncState.Error("Chức năng đồng bộ đã bị vô hiệu hóa tạm thời do lỗi kỹ thuật. Vui lòng thử lại sau.")
            ...
            try {
                ...
                Log.e("PersonalTasksViewModel", "Error hiding sync disabled message", e)
            }
        }
    }
