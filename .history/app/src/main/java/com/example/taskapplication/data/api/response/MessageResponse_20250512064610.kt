...
data class MessageResponse(
    ...
    @SerializedName("receiver_id") val receiverId: Long? = null,
    @SerializedName("created_at") val timestamp: Long,
    @SerializedName("updated_at") val lastModified: Long,
    @SerializedName("created_at") val createdAt: Long,
    @SerializedName("read_status") val readBy: List<Long> = emptyList(),
    @SerializedName("reactions") val reactions: List<ReactionResponse> = emptyList(),
