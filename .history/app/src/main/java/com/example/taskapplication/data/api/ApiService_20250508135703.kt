...
import com.example.taskapplication.data.model.PersonalTaskRequest
import com.example.taskapplication.data.model.PersonalTaskResponse
import com.example.taskapplication.data.model.TeamTaskRequest
import com.example.taskapplication.data.model.TeamTaskResponse
import com.example.taskapplication.data.model.MessageRequest
import com.example.taskapplication.data.model.MessageResponse
import com.example.taskapplication.data.model.TeamRequest
import com.example.taskapplication.data.model.TeamResponse
import com.example.taskapplication.data.model.TeamMemberRequest
import com.example.taskapplication.data.model.TeamMemberResponse
import com.example.taskapplication.data.model.UserRequest
import com.example.taskapplication.data.model.UserResponse
...
interface ApiService {
    ...
    suspend fun updatePersonalTask(@Path("id") id: String, @Body request: PersonalTaskRequest): Response<PersonalTaskResponse>
    ...
    @PUT("team-tasks/{id}")
    suspend fun updateTeamTask(@Path("id") id: String, @Body request: TeamTaskRequest): Response<TeamTaskResponse>
    ...
    @PUT("messages/{id}")
    suspend fun updateMessage(@Path("id") id: String, @Body request: MessageRequest): Response<MessageResponse>
    ...
    @PUT("teams/{id}")
    suspend fun updateTeam(@Path("id") id: String, @Body request: TeamRequest): Response<TeamResponse>
