...
interface ApiService {
    ...
    @GET("personal-tasks/categories")
    suspend fun getPersonalTaskCategories(): Response<List<String>>

    @GET("personal-tasks/statistics")
    suspend fun getPersonalTaskStatistics(
        @Query("period") period: String? = null, // "day", "week", "month", "year"
        @Query("start_date") startDate: String? = null,
        @Query("end_date") endDate: String? = null
    ): Response<Map<String, Any>>

    @POST("personal-tasks/batch")
    suspend fun batchUpdatePersonalTasks(@Body request: List<PersonalTaskRequest>): Response<List<PersonalTaskResponse>>
