        ...
        Box(
            ...
            when {
                ...
                task != null -> {
                    ...
                    val isTaskOverdue = currentTask.dueDate?.let { it < System.currentTimeMillis() } ?: false
                    val textColor = when {
                        currentTask.status == "completed" -> MaterialTheme.colorScheme.onSurface.copy(alpha = 0.6f)
                        ...
                        Row(
                            ...
                            Checkbox(
                                ...
                                onCheckedChange = {
                                    ...
                                    task = currentTask.copy(status = if (currentTask.status == "completed") "pending" else "completed")
                                }
                            )
                            ...
                            Text(
                                ...
                                color = textColor,
                                textDecoration = if (currentTask.status == "completed") TextDecoration.LineThrough else TextDecoration.None
                            )
                        }
                                ...
                                currentTask.dueDate?.let { dueDate ->
                                    Row(
                                        ...
                                        Icon(
                                            ...
                                            tint = if (isTaskOverdue && currentTask.status != "completed")
                                        ...
                                        Column {
                                            ...
                                            Text(
                                                ...
                                                color = if (isTaskOverdue && currentTask.status != "completed")
                                                    MaterialTheme.colorScheme.error
                                                else
                                ...
                                Row(
                                    ...
                                    Icon(
                                        ...
                                        tint = when (currentTask.priority) {
                                            "low" -> MaterialTheme.colorScheme.primary.copy(alpha = 0.5f) // Low
                                            "medium" -> MaterialTheme.colorScheme.primary // Medium
                                            "high" -> MaterialTheme.colorScheme.error // High
