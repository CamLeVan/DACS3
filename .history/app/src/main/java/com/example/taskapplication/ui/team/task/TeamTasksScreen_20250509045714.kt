...
/**
 * Screen that displays tasks for a team in either list or kanban view
 */
    ...
    Scaffold(
        topBar = {
            Column {
                ...
                // Tab row for switching between list and kanban views
                TabRow(
                    selectedTabIndex = viewMode.ordinal
                ) {
                    Tab(
                        selected = viewMode == TaskViewMode.LIST,
                        onClick = { viewMode = TaskViewMode.LIST },
                        text = { Text("List") },
        ...
        Box(
            ...
            when (viewMode) {
                ...
                TaskViewMode.KANBAN -> {
                    ...
                    KanbanBoardScreen(
                        teamId = teamId,
                        onBackClick = { viewMode = TaskViewMode.LIST }, // Switch back to list view
