...
interface ApiService {
    ...
    @POST("teams/{team}/chat")
    suspend fun sendTeamMessage(
        @Path("team") teamId: Long,
        @Body message: MessageRequest
    ): Response<MessageResponse>

    @PUT("teams/{team}/chat/{message}/read")
    suspend fun markMessageAsRead(
        @Path("team") teamId: Long,
        @Path("message") messageId: Long
    ): Response<Unit>

    @GET("teams/{team}/chat/unread")
    suspend fun getUnreadCount(@Path("team") teamId: Long): Response<UnreadCountResponse>

    @POST("teams/{team}/chat/typing")
    suspend fun updateTypingStatus(
        @Path("team") teamId: Long,
        @Body typingStatus: TypingStatusRequest
    ): Response<Unit>

    @POST("teams/{team}/chat/retry/{clientTempId}")
    suspend fun retryMessage(
        @Path("team") teamId: Long,
        @Path("clientTempId") clientTempId: String
    ): Response<MessageResponse>

    @PUT("teams/{team}/chat/{message}")
    ...
    @DELETE("teams/{team}/chat/{message}")
    suspend fun deleteMessage(
        @Path("team") teamId: Long,
        @Path("message") messageId: Long
    ): Response<Unit>

    @POST("teams/{team}/chat/{message}/react")
