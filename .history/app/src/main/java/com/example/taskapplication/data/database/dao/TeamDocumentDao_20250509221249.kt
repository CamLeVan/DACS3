...
interface TeamDocumentDao {
    ...
    fun getDocumentsByTeam(teamId: String): Flow<List<TeamDocumentEntity>>
    
    /**
     * Get document by ID
     */
    @Query("SELECT * FROM team_documents WHERE id = :documentId")
    suspend fun getDocumentById(documentId: String): TeamDocumentEntity?
    
    /**
     * Get documents by server ID
     */
    @Query("SELECT * FROM team_documents WHERE serverId = :serverId")
    suspend fun getDocumentByServerId(serverId: String): TeamDocumentEntity?
    ...
    fun getDocumentsByUser(userId: String): Flow<List<TeamDocumentEntity>>
    ...
    fun getDocumentsByAccessLevel(teamId: String, accessLevel: String): Flow<List<TeamDocumentEntity>>
    ...
    fun getDocumentsByFileType(teamId: String, fileType: String): Flow<List<TeamDocumentEntity>>
    ...
    fun searchDocuments(teamId: String, query: String): Flow<List<TeamDocumentEntity>>
